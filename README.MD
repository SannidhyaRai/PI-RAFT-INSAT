...
For Colab environments, import the orchestration notebook located at [baseline.ipynb](file:///c:/Users/Yash/OneDrive/Desktop/IMD_AMV_DOF/PI-RAFT-INSAT/notebooks/baseline.ipynb). It is structured to run setting commands and packages directly, install the repository, and execute model training headless.